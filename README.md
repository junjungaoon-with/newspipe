...
### LLM のプロンプトエンジニアリングを体系化したい
    現状は成功した prompt を採用しているが、
    “なぜ成功したか” の言語化や改善ループを深めたい
...
## インストールとセットアップ
1. クローン
git clone https://github.com/yourname/newspipe.git
cd newspipe
...
設定は config/settings.py , config/channels/baseball.ymlで調整できます。
